...
Shader "SoFunny/Funnyland/FunnyStyle"
{
    ...
    Properties
    {
        ...
        _RoughnessHigh("Roughness High", Range(0.5, 1.0)) = 0.7
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // -------------------------------------
            // Includes
            #include "Packages/com.unity.render-pipelines.universal/Shaders/Funnyland/Libs/FunnyStyleInput.hlsl"
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.FunnyStyleShader"
