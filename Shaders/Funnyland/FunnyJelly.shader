Shader "SoFunny/Funnyland/FunnyJelly"
{
    Properties
    {
    ...
    SubShader
    {
        Tags { "RenderType" = "Opaque" "UniversalMaterialType" = "SimpleLit" "IgnoreProjector" = "True" }
        LOD 300
        ...
        Pass
        {
            ...
            // -------------------------------------
            // Includes
            #include "Packages/com.unity.render-pipelines.universal/Shaders/Funnyland/Libs/FunnyJelly/FunnyJellyInput.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Shaders/Funnyland/Libs/FunnyJelly/FunnyJellyShading.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Shaders/Funnyland/Libs/FunnyJelly/FunnyJellyForwardPass.hlsl"
            ENDHLSL
        }
    ...
    CustomEditor "SoFunny.Rendering.Funnyland.FunnyJellyShader"
