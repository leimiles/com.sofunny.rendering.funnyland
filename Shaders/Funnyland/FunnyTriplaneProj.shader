...
Shader "SoFunny/Funnyland/FunnyTriplaneProj"
{
    ...
    Properties
    {
        ...
        _BlendRange ("Blend Range", Range(1, 20)) = 1
        _TillingAndOffset ("Tilling And Offset", Float) = (1, 1, 0, 0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // -------------------------------------
            // Includes
            #include "Packages/com.unity.render-pipelines.universal/Shaders/Funnyland/Libs/FunnyTriplaneProjInput.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Shaders/Funnyland/Libs/FunnyLitShading.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Shaders/Funnyland/Libs/FunnyTriplaneProjForwardPass.hlsl"
            ENDHLSL
        }
    ...
    CustomEditor "SoFunny.Rendering.Funnyland.FunnyTriplaneProjShader"
}
