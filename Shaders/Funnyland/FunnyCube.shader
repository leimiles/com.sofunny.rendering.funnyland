...
Shader "SoFunny/Funnyland/FunnyCube"
{
    // Keep properties of StandardSpecular shader for upgrade reasons.
    Properties
    {
        _BaseColor ("Base Color", Color) = (1, 1, 1, 1)
        _BaseColor01 ("Base Color Mask White", Color) = (1, 1, 1, 1)
        _BaseColor02 ("Base Color Mask Black", Color) = (1, 1, 1, 1)
        _MaskTex ("Mask Texture", 2D) = "white" { }
        [Enum(Mask On, 0, Mask Off, 1)]_MaskThreshold ("Mask Threshold", Float) = 0
