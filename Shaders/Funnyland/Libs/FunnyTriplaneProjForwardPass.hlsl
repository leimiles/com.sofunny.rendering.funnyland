#ifndef FUNNY_TRIPLANEPROJ_PASS_INCLUDED
#define FUNNY_TRIPLANEPROJ_PASS_INCLUDED
...
void InitializeTriplaneProjSurfaceData(Varyings input, out FunnySurfaceData outSurfaceData)
{
    outSurfaceData = (FunnySurfaceData)0;
    
    // basemap
    float2 uv_Z = input.positionWS.xy * _TillingAndOffset.xy + _TillingAndOffset.zw;
    float2 uv_X = input.positionWS.zy * _TillingAndOffset.xy + _TillingAndOffset.zw;
    float2 uv_Y = input.positionWS.xz * _TillingAndOffset.xy + _TillingAndOffset.zw;
...
)
{
    ...
    InitializeTriplaneProjSurfaceData(input, surfaceData);
