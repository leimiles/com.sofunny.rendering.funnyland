...
namespace SoFunny.Rendering.Funnyland
{
    ...
    /// </summary>
    public class FunnyColorGradingLutPass : ScriptableRenderPass
    {
        ...
        public FunnyColorGradingLutPass(RenderPassEvent evt, PostProcessData data)
        {
        ...
        public void Setup(in RTHandle internalLut, PostVolumeData volumeData)
        {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            ExecutePass(context, m_PassData, m_VolumeData, ref renderingData, m_InternalLut);
        }
        ...
        private static void ExecutePass(ScriptableRenderContext context, PassData passData, PostVolumeData volumeData, ref RenderingData renderingData, RTHandle internalLutTarget)
        {
        ...
        internal void Render(RenderGraph renderGraph, out TextureHandle internalColorLut, ref RenderingData renderingData)
        {
            using (var builder = renderGraph.AddRenderPass<PassData>("Color Lut Pass", out var passData, base.profilingSampler))
            {
                ...
                {
                    ExecutePass(context.renderContext, data, m_VolumeData, ref data.renderingData, data.internalLut);
                });
