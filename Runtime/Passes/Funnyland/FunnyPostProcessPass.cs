...
namespace SoFunny.Rendering.Funnyland
{
    public class PostVolumeData{
        // volumeData
        public VolumeProfile sharedProfile;
        // Default VolumeData
        public VolumeStack sharedStack;

        public PostVolumeData(VolumeProfile volumeProfile, VolumeStack volumeStack) {
            sharedProfile = volumeProfile;
            sharedStack = volumeStack;
        }
    }
    ...
    /// </summary>
    internal class FunnyPostProcessPass : ScriptableRenderPass
    {
        ...
        PostVolumeData m_postVolumeData;
        // Misc
        ...
        public FunnyPostProcessPass(RenderPassEvent evt, PostProcessData data, ref PostProcessParams postProcessParams)
        {
        ...
        public void Setup(in RenderTextureDescriptor baseDescriptor, in RTHandle source, bool resolveToScreen, PostVolumeData postVolumeData, in RTHandle depth, in RTHandle internalLut, in RTHandle motionVectors, bool hasFinalPass, bool enableColorEncoding)
        {
            ...
            m_postVolumeData = postVolumeData;
        }
        ...
        /// <param name="hasFinalPass"></param>
        /// <param name="enableColorEncoding"></param>
        public void Setup(in RenderTextureDescriptor baseDescriptor, in RTHandle source, RTHandle destination, PostVolumeData postVolumeData, in RTHandle depth, in RTHandle internalLut, bool hasFinalPass, bool enableColorEncoding)
        {
            m_Descriptor = baseDescriptor;
            m_Descriptor.useMipMap = false;
            m_Descriptor.autoGenerateMips = false;
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            var stack = m_postVolumeData.sharedStack;
