...
namespace SoFunny.Rendering.Funnyland
{
    ...
    /// </summary>
    public static class FunnyTriplaneProjGUI
    {
        /// <summary>
        ...
        public static class Styles
        {
            ...
            public static GUIContent metallicMapText =
                EditorGUIUtility.TrTextContent("MixMap(R:Metallic G:AO B:RoughnessMask)", "MixMap R:Metallic G:AO B:Roughness.");


            public static GUIContent roughnessHighText = EditorGUIUtility.TrTextContent("Roughness High",
            ...
            public static GUIContent blendRangeText = EditorGUIUtility.TrTextContent("Blend Range", "控制三面映射边缘的混合程度");
            
            public static GUIContent tillingAndOffsetText = EditorGUIUtility.TrTextContent("Tilling And Offset");
        ...
        public struct LitProperties
        {
            ...
            public MaterialProperty blendRange;

            public MaterialProperty tillingAndOffset;
            ...
            public LitProperties(MaterialProperty[] properties)
            {
                ...
                blendRange = BaseShaderGUI.FindProperty("_BlendRange", properties, false);
                tillingAndOffset = BaseShaderGUI.FindProperty("_TillingAndOffset", properties, false);
        ...
        public static void Inputs(LitProperties properties, MaterialEditor materialEditor, Material material)
        {
            ...
            DoBlendRange(materialEditor, material, properties.blendRange);
            DoTillingAndOffset(materialEditor, material, properties.tillingAndOffset);
        }
        ...
        public static void DoRoughness(MaterialEditor materialEditor, Material material, MaterialProperty roughnessHigh, MaterialProperty roughnessLow)
        {
            ...
            materialEditor.ShaderProperty(roughnessHigh, Styles.roughnessHighText);
        ...
        public static void DoBlendRange(MaterialEditor materialEditor, Material material, MaterialProperty blendRange)
        {
            EditorGUI.indentLevel += 2;
            materialEditor.ShaderProperty(blendRange, Styles.blendRangeText);
            EditorGUI.indentLevel -= 2;
        }
        
        public static void DoTillingAndOffset(MaterialEditor materialEditor, Material material, MaterialProperty tillingAndOffset)
        {
            EditorGUI.indentLevel += 2;
            materialEditor.ShaderProperty(tillingAndOffset, Styles.tillingAndOffsetText);
            EditorGUI.indentLevel -= 2;
        }
