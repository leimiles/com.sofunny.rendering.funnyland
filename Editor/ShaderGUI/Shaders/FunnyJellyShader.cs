...
{
    internal class FunnyJellyShader : BaseShaderGUI
    {
        static readonly string[] workflowModeNames = Enum.GetNames(typeof(FunnyLitGUI.WorkflowMode));

        private FunnyJellyGUI.LitProperties litProperties;
        ...
        public override void FindProperties(MaterialProperty[] properties)
        {
            ...
            litProperties = new FunnyJellyGUI.LitProperties(properties);
        }
        ...
        public override void DrawSurfaceInputs(Material material)
        {
            ...
            FunnyJellyGUI.Inputs(litProperties, materialEditor, material);
        ...
        public override void DrawAdvancedOptions(Material material)
        {
            ...
            FunnyJellyGUI.DrawAdvancedOptions(litProperties, materialEditor, material);
