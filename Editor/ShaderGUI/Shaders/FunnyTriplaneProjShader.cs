...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    ...
    {
        static readonly string[] workflowModeNames = Enum.GetNames(typeof(FunnyTriplaneProjGUI.WorkflowMode));

        private FunnyTriplaneProjGUI.LitProperties litProperties;

        // collect properties from the material properties
        public override void FindProperties(MaterialProperty[] properties)
        {
            base.FindProperties(properties);
            litProperties = new FunnyTriplaneProjGUI.LitProperties(properties);
        }
        ...
        public override void DrawSurfaceInputs(Material material)
        {
            ...
            FunnyTriplaneProjGUI.Inputs(litProperties, materialEditor, material);
        ...
        public override void DrawAdvancedOptions(Material material)
        {
            ...
            {
                materialEditor.ShaderProperty(litProperties.highlights, FunnyTriplaneProjGUI.Styles.highlightsText);
                materialEditor.ShaderProperty(litProperties.reflections, FunnyTriplaneProjGUI.Styles.reflectionsText);
            }
        ...
        public override void AssignNewShaderToMaterial(Material material, Shader oldShader, Shader newShader)
        {
            ...
            {
                material.SetFloat("_WorkflowMode", (float)FunnyTriplaneProjGUI.WorkflowMode.Specular);
            ...
            {
                material.SetFloat("_WorkflowMode", (float)FunnyTriplaneProjGUI.WorkflowMode.Metallic);
