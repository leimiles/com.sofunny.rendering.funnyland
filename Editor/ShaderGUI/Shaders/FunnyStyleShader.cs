...
{
    internal class FunnyStyleShader : BaseShaderGUI
    {
        static readonly string[] workflowModeNames = Enum.GetNames(typeof(FunnyStyleGUI.WorkflowMode));

        private FunnyStyleGUI.LitProperties litProperties;

        // collect properties from the material properties
        public override void FindProperties(MaterialProperty[] properties)
        {
            base.FindProperties(properties);
            litProperties = new FunnyStyleGUI.LitProperties(properties);
        }
        ...
        public override void DrawSurfaceInputs(Material material)
        {
            ...
            FunnyStyleGUI.Inputs(litProperties, materialEditor, material);
        ...
        public override void DrawAdvancedOptions(Material material)
        {
            ...
            {
                materialEditor.ShaderProperty(litProperties.highlights, FunnyStyleGUI.Styles.highlightsText);
                materialEditor.ShaderProperty(litProperties.reflections, FunnyStyleGUI.Styles.reflectionsText);
            }
        ...
        public override void AssignNewShaderToMaterial(Material material, Shader oldShader, Shader newShader)
        {
            ...
            {
                material.SetFloat("_WorkflowMode", (float)FunnyStyleGUI.WorkflowMode.Specular);
            ...
            {
                material.SetFloat("_WorkflowMode", (float)FunnyStyleGUI.WorkflowMode.Metallic);
